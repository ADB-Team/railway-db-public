...
```sql
2021-01-07 13:41:43.683 UTC [889] LOG:  duration: 48.007 ms  plan:
	Query Text: /*
...
Delete connected passengers_schedule entries:

```sql
2021-01-07 13:41:47.675 UTC [889] LOG:  duration: 2.905 ms  plan:
	...
	Delete on passengers_schedule  (cost=0.00..752.60 rows=0 width=0)
	  ->  Seq Scan on passengers_schedule  (cost=0.00..752.60 rows=216 width=6)
	        Filter: ($1 = connection)
2021-01-07 13:41:47.675 UTC [889] CONTEXT:  SQL statement "DELETE FROM ONLY "public"."passengers_schedule" WHERE $1 OPERATOR(pg_catalog.=) "connection""
```

Delete connection:

```sql
2021-01-07 13:41:47.676 UTC [889] LOG:  duration: 3976.090 ms  plan:
