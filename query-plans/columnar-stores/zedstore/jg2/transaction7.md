...
```sql
2021-01-08 14:43:25.756 UTC [1117] LOG:  duration: 36.760 ms  plan:
	Query Text: /*
...
# Delete passengers_schedule entries with cancelled connection

For every entry with cancelled connection:

```sql
2021-01-08 14:43:25.820 UTC [1117] LOG:  duration: 3.823 ms  plan:
...
# Delecte connections with out-of-order trains

```sql
2021-01-08 14:43:29.622 UTC [1117] LOG:  duration: 3841.929 ms  plan:
