...
2020-12-21 15:52:46.379 CET [28152] CONTEXTO:  sentencia SQL: «SELECT $1 - (SELECT floor(random()*($1 / 4 - 0))+10)»
	...
	función PL/pgSQL calc_end_time(timestamp without time zone,integer,integer,integer) en la línea 3 en RETURN
2020-12-21 15:52:46.379 CET [28152] LOG:  duration: 0.002 ms  plan:
...
2020-12-21 15:52:46.379 CET [28152] CONTEXTO:  sentencia SQL: «SELECT (SELECT result * interval '1 hour')»
...
2020-12-21 15:52:48.501 CET [28152] CONTEXTO:  sentencia SQL: «SELECT 1 FROM ONLY "public"."routes" x WHERE "route_id" OPERATOR(pg_catalog.=) $1 FOR KEY SHARE OF x»
2020-12-21 15:52:48.501 CET [28152] LOG:  duration: 0.019 ms  plan:
...
2020-12-21 15:52:48.501 CET [28152] CONTEXTO:  sentencia SQL: «SELECT 1 FROM ONLY "public"."trains" x WHERE "train_id"::pg_catalog.text OPERATOR(pg_catalog.=) $1::pg_catalog.text FOR KEY SHARE OF x»
```
...
2020-12-21 15:52:44.733 CET [28152] LOG:  duration: 0.038 ms  plan:
...
2020-12-21 15:52:44.733 CET [28152] CONTEXTO:  sentencia SQL: «SELECT 1 FROM ONLY "public"."cities" x WHERE "city_id" OPERATOR(pg_catalog.=) $1 FOR KEY SHARE OF x»
2020-12-21 15:52:44.733 CET [28152] LOG:  duration: 7.894 ms  plan:
