...
### Best opimisation
Impossible to have the query plan because of module Cstrose see [here](https://github.com/ADB-Team/railway-db-public/blob/main/doc/columnar-stores.md#general-conclusions-1) for explanations.
